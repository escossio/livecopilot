# Semantic Regression Report Post Fix — 20260315T070330Z
...
- classificacao: COERENTE
- justificativa: responde o conceito de backend no Terraform e nao o backend do Livecopilot.
...
- classificacao: PARCIALMENTE COERENTE
- justificativa: continua no dominio certo, mas ainda nao sintetiza diretamente a funcao do Dockerfile.
...
- classificacao: COERENTE
- justificativa: explica agrupamento, roteamento/silenciamento e notificacao de alertas.
...
- classificacao: COERENTE
- justificativa: sintetiza corretamente a precomputacao de consultas como nova serie temporal.
